 ...
 * @Smush theme created by smartforums.co
 *
 * @version 2.1 Beta 3
 */
...
<head>
	...
	// Load our own theme styles here.
	echo '
	<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/css/smush.css" />';
...
function template_body_below()
{
	...
	// Theme copyright links must be in place at all times when using this theme, this is all we ask.
		echo '
		<ul>
			...
			<li class="mycopyright">', $txt['smart_rights'], ' <a href="https://www.simpleforums.net/">', $txt['smart_link'], '</a></li>
		</ul>';
